...
SECRET_KEY = 'zup=4-=4lxt^$#@2$xdcn9td7d!5vie1dvvdqk@eq*s^2@xus4'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(os.path.dirname( __file__ ), '..', 'crmapp/templates'),
                 ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
##    },
        ...
        'NAME': 'zlmykoqp',
        'USER': 'zlmykoqp',
        'PASSWORD': 'TBhhoVSyn7JbOmfIZifZiDuYgAmAmhq4',
